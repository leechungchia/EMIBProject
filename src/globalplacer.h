...
public:
    GlobalPlacer(char* die_input, char* EMIB_input, string net_input, int net_num, string mode, int t_seed, int t_initial_seed){
        ...
        for(int i=0; i<m_ECGs.size(); ++i){
            ...
            cout << endl;
            m_initial_topology_generation(i);
            ...
            new_partialplacer->set_placer(this, i);
    ...
    bool m_check_equal(TCG* t_tree1, vector<TCG*> t_trees);
    vector<ECG*>  m_ECGs;
    void m_initial_topology_generation(int t_index);
